...
1. **View Generated URL**:
   ...
   - Slack shows a webhook URL composed of several path segments after `/services/`; see Slack’s Incoming Webhooks setup screen (do **not** commit real webhook URLs to public repos).
